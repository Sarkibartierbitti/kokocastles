...
| 2026-05-08 1840Z | local | `5af0777` | Phase 3b + Phase 4 shipped: Videos toolbar (search/filter/sort/hide/export field-ticks) + Ideas page (Inbox/Shortlist + LLM gen + search). 149 tests green. |
